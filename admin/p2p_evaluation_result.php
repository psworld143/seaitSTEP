                    ...
                    if (isset($_GET['subject_id'])) {
                      ...
                      if (mysqli_num_rows($comment_query) != 0) {
                        ...
                        while ($comment_row = mysqli_fetch_assoc($comment_query)) {
                          ...
                          $get_total_score_query = mysqli_query($conn, "SELECT SUM(score) AS total_score FROM p2p_evaluation WHERE teacher_id = '$id' AND subject_id='$s_id' AND acad_year='$academic_year'");
                          ...
                          $total_rating_comment = round(($total_score_comment / $total_questions), 2);
...
<script>
  window.onload = function() {
    var chart = new CanvasJS.Chart("chartContainer", {
      ...
      subtitles: [{
        text: " Evaluated by <?php echo $total_evaluators; ?> Faculty"
      }],
      data: [{
        type: "doughnut",
        indexLabel: "{symbol} - {y}",
