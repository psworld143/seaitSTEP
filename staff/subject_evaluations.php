              ...
              <div class="email-wrapper row remain-height bgc-white ov-h">
                ...
                <div class="email-list h-100 layers">
                  ...
                  <div class="layer w-100 fxg-1 scrollable pos-r">
                    <?php
                    if (isset($_GET['subject_id'])) {
                      $comment_query = mysqli_query($conn, "SELECT *, student_evaluation.added AS comment_date FROM student_evaluation LEFT JOIN step_users ON step_users.id = student_evaluation.student_id WHERE student_evaluation.subject_id = '$subject_id' AND teacher_id = '$id' AND acad_year = '$academic_year' GROUP BY student_evaluation.comment ");
                            ...
                            while ($cat_rows = mysqli_fetch_assoc($categories)) {
                              ...
                              while ($row_question = mysqli_fetch_assoc($questions)) {
                                ...
                                echo '
                                        ...
                                        ';
                                $rating_query = mysqli_query($conn, "SELECT SUM(score) AS total_score FROM student_evaluation WHERE question_id = '$q_id' AND subject_id='$subject_id'  AND acad_year = '$academic_year'  AND teacher_id = '$id'");
                                ...
                                $total_evaluators_query = mysqli_query($conn, "SELECT COUNT(*) FROM student_evaluation WHERE question_id = '$q_id' AND subject_id='$subject_id'  AND acad_year = '$academic_year'  AND teacher_id = '$id' GROUP BY student_id");
