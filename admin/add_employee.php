    ...
    <div>
      ...
      <div class="page-container">
        ...
        <main class="main-content bgc-grey-100">
          <form action="../backend_scripts/add_new_employee.php" method="POST" enctype="multipart/form-data">
            <div id="mainContent">
            ...
            <div style="margin-top: 2%;">
              <center><button type="submit" class="btn btn-primary btn-color"><i class="fa fa-plus"></i> ADD NEW FACULTY</button></center>
            </div>
          </form>
