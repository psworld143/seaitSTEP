            ...
            <div class="row">
              <div class="col-md-12">
                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                  ...
                  <button type="button" class="btn cur-p btn-info btn-sm btn-color" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-bottom: 2%;"><i class="ti-plus"></i> Add New </button>
                  <!--Modal-->
                  ...
                  <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      ...
                      while ($rows = mysqli_fetch_assoc($query)) {
                        ...
                        echo '<td><span class="badge rounded-pill fl-l bg-success lh-0 p-10">' . $total . '</span></td>';

                        echo '
                          <td>

                            <a href="view_instructors.php?dept_id=' . $id . '" class="btn cur-p btn-info btn-sm btn-color"><i class="ti-user"></i> Instructors</a>
                            <button type="button" class="btn cur-p btn-danger btn-color btn-sm" data-bs-toggle="modal" data-bs-target="#delete' . $id . '"><i class="ti-trash"></i> Delete</button>
                                          <div class="modal fade" id="delete' . $id . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                <form action="../backend_scripts/delete_department.php" method="POST">
                                                    <div class="mb-3">   
