                                ...
                                ';
                                    ...
                                    while($row_question = mysqli_fetch_assoc($questions)){
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <button type="button" class="btn btn-info" data-bs-dismiss="modal"><i class="ti-pencil-alt2"></i></button>
                                          <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="ti-trash"></i></button>
                                        </td>
                                      </tr>
