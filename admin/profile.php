        ...
        <div id="mainContent">
          <div class="row gap-20 masonry pos-r">
            ...
            <div class="masonry-item col-md-6">
              ...
              <!--        <tr>   -->
              <!--          <td>Email Address</td>-->
              <!--          <th scope="row"><?php //echo $rows['email']; 
                                            ?></th>-->
              <!--        </tr>-->
            ...
            <div class="masonry-item col-md-6">
              <div class="bgc-white p-20 bd">
                <center>
                  <h6 class="c-grey-900">Student Evaluation Summary</h6>
            ...
            <div class="masonry-item col-md-6">
              <div class="bgc-white p-20 bd">
                <center>
                  <h6 class="c-grey-900">Students Rating per Questions for this semester</h6>
                </center>
