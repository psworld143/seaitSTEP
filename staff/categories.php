            ...
            <div class="col-md-12">
              <div class="bgc-white bd bdrs-3 p-20 mB-20">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="../backend_scripts/add_new_h2f_category.php" method="POST">
                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                    $categories = mysqli_query($conn, "SELECT * FROM h2f_category ORDER BY cat_name ASC");
                    $count = 0;
                    while ($cat_rows = mysqli_fetch_assoc($categories)) {
                      $count += 1;
                      $id = $cat_rows['id'];
                      $cat_count = 0;
                      $total_questions = mysqli_query($conn, "SELECT COUNT(*) AS total_questionaires FROM h2f_questionaires WHERE cat_id = '$id'");
                                  ...
                                  <div class="modal fade" id="delete' . $id . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="../backend_scripts/delete_h2f_category.php" method="POST">
                                        ...
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-secondary btn-sm btn-color" data-bs-dismiss="modal">Cancel</button>
                                          <button type="submit" class="btn btn-danger btn-sm btn-color">Delete</button>
                                        </div>
                                        </form>
                                      </div>
                                    </div>
