        ...
        <main class="main-content bgc-grey-100">
          <div id="mainContent">
            <div class="full-container">
                  ...
                  <div class="h-100 layers">
                    ...
                    <div class="scrollable pos-r bdT layer w-100 fxg-1">
                      <ul class="p-20 nav flex-column">
                        <?php
                          $subjects_query = mysqli_query($conn, "SELECT * FROM subject_loads LEFT JOIN subjects ON subjects.id = subject_loads.subject WHERE subject_loads.teacher = '$id'");
                          while($subject_row = mysqli_fetch_assoc($subjects_query)){
                            echo '
                              <li class="nav-item" title="'.$subject_row['description'].'">
                              <form method="POST" action="evaluation_result.php">
                              <input type="hidden" name="subject_id" value="'.$subject_row['subject'].'">
                                <button type="submit" class="nav-link c-grey-800 cH-blue-500 actived">
              ...
              <div class="email-wrapper row remain-height bgc-white ov-h" style="width: 100%">
                      ...
                      <div class="bdT pX-40 pY-30">
                        ...
                        <div class="row">
                          ...
                          if(isset($_POST['subject_id'])){
                                ...
                                <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                  ...
                                  ';
                                      ...
                                      while($row_question = mysqli_fetch_assoc($questions)){
                                        ...
                                        ';
                                          $rating_query = mysqli_query($conn, "SELECT SUM(score) AS total_score FROM student_evaluation WHERE question_id = '$q_id' AND subject_id='$subject_id'  AND acad_year = '$academic_year'");
                                          ...
                                          $total_evaluators_query = mysqli_query($conn, "SELECT COUNT(*) FROM student_evaluation WHERE question_id = '$q_id' AND subject_id='$subject_id'  AND acad_year = '$academic_year' GROUP BY student_id");
                            ...
                            echo "<center><h6>No evaluation data found. Try to select subject first.</h6></center>";
                          }
                ...
                <div class="masonry-item col-md-5" style="overflow: hidden;">
                  <div class="p-20 bgc-grey-100 layer w-100">
                          <!-- <a href="employees.php" class="btn btn-danger bdrs-50p p-15 lh-0">
                            <i class="fa fa-reply"></i>
                          </a> -->
                  ...
                  <?php
                      if(1==1){
                        $comment_query = mysqli_query($conn, "SELECT *, student_evaluation.added AS comment_date FROM student_evaluation LEFT JOIN step_users ON step_users.id = student_evaluation.student_id WHERE student_evaluation.teacher_id = '$id' GROUP BY student_evaluation.comment ");
                        if(mysqli_num_rows($comment_query) != 0){
                          ...
                          while($comment_row = mysqli_fetch_assoc($comment_query)){
                            ...
                            $get_total_score_query = mysqli_query($conn, "SELECT SUM(score) AS total_score FROM student_evaluation WHERE student_id = '$student_id' AND acad_year='$academic_year'");
