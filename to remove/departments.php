                    ...
                    <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                      ...
                      <tbody>
                        ...
                        while($rows = mysqli_fetch_assoc($query)){
                          ...
                          echo '
                          <td>
                            <a href="view_instructors.php?dept_id='.$id.'" class="btn cur-p btn-info btn-color">View Instructors</a>
                            <button type="button" class="btn cur-p btn-danger btn-color">Delete</button>
                          </td> 
                          </tr>
                          ';
                        }
