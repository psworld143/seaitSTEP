    ...
    <ul class="sidebar-menu scrollable pos-r" >
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li>
            <a class="sidebar-link" href="questionaires.php">Questionnaires</a>
          </li> 
        </ul>
      </li>
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li>
            <a class="sidebar-link" href="p2p_questionaires.php">Questionnaires</a>
          </li> 
        </ul>
      </li>
 <!--      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="sidebar-link" href="manage_student.php">
          <span class="icon-holder">
