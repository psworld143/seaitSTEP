                ...
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20 mB-20">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="../backend_scripts/add_new_category.php" method="POST">
                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                          $categories = mysqli_query($conn, "SELECT * FROM category ORDER BY cat_name ASC");
                          $count = 0;
                          while($cat_rows = mysqli_fetch_assoc($categories)){
                            $count +=1;
                            $id = $cat_rows['id'];
                            $cat_count = 0;
                            $total_questions = mysqli_query($conn, "SELECT COUNT(*) AS total_questionaires FROM questionaires WHERE cat_id = '$id'");
                            ...
                            echo '
                            <tr>
                              <th scope="row"><center><span class="badge rounded-pill fl-l bg-info lh-0 p-10">'.$count.'</span></center></th>
                                  ...
                                  <div class="modal fade" id="delete'.$id .'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          <form action="../backend_scripts/delete_category.php" method="POST">
