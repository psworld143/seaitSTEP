                    ...
                    <tbody>
                      ...
                      while ($rows = mysqli_fetch_assoc($query)) {
                        ...
                        echo '
                          ...
                          <td><a href="profile.php?eid=' . $encrypted_id . '">' . $rows['lastname'] . ', ' . $rows['firstname'] . ' ' . $rows['middlename'] . '</a></td>
                          ...
                          <td>
                            <form action="subject_evaluations.php" method="POST">
                              ...
                              <a href="h2f_evaluation_result.php?id=' . $encrypted_id . '" class="btn cur-p btn-success btn-color btn-sm"> HEADS</a>
                            </form>
