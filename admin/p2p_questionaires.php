            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <h4 class="c-grey-900 mB-20">Peer to Peer Evaluation Questionaires</h4>
                    <button type="button" class="btn cur-p btn-info btn-color" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-bottom: 2%;">Add New </button>
                    <!--Modal-->
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="../backend_scripts/add_new_p2p_questionaire.php" method="POST">
                              ...
                              <div class="mT-30">
                                <div class="mb-3">
                                  ...
                                  <select id="inputState" name="cat_id" class="form-control" required>
                                    ...
                                    <?php
                                      $cat = mysqli_query($conn, "SELECT * FROM p2p_category ORDER BY added ASC");
                              ...
                              <div class="bgc-white bd bdrs-3 p-20 mB-20">
                                ...
                                ';
                                    ...
                                    while($row_question = mysqli_fetch_assoc($questions)){
                                      ...
                                      echo '
                                      <tr>
                                        <td><span class="badge rounded-pill fl-l bg-success lh-0 p-10">'.$q_number.'</span></td>
                                        <td>'.$row_question['description'].'</td>
                                        <td>
                                          <button type="button" class="btn cur-p btn-info btn-color" data-bs-toggle="modal" data-bs-target="#edit'.$row_question['id'].'"><i class="ti-pencil-alt2"></i></button>
                                          <div class="modal fade" id="edit'.$row_question['id'].'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  <form action="../backend_scripts/edit_p2p_questionaire.php" method="POST">
                                          ...
                                          <button type="button" class="btn cur-p btn-danger btn-color" data-bs-toggle="modal" data-bs-target="#delete'.$row_question['id'].'"><i class="ti-trash"></i></button>
                                          <div class="modal fade" id="delete'.$row_question['id'].'" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                <form action="../backend_scripts/delete_p2p_questionaire.php" method="POST">
                                                    <div class="mb-3">   
