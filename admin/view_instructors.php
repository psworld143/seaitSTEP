              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20">
                    ...
                    <div class="peer">
                        <a href="add_employee.php" class="btn btn-sm cur-p btn-info btn-color">Add New Faculty</a>
                    </div>
                      ...
                      <tbody>
                        ...
                        while($rows = mysqli_fetch_assoc($query)){
                          ...
                          <td>
                            ...
                            <a href="" class="btn cur-p btn-danger btn-color btn-sm" data-bs-toggle="modal" data-bs-target="#delete'.$id .'" >Delete Faculty</a>
                          </td> 
                          <td>
