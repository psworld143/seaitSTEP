              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="bgc-white bd bdrs-3 p-20">
                    ...
                    <div class="peer">
                      <button type="button" class="btn btn-primary btn-color btn-sm" data-bs-toggle="modal" data-bs-target="#addSubjectLoad">Add Subject Load</button>
                      Can't find subject? add it <a class="" data-bs-toggle="modal" data-bs-target="#registerSubject" style="cursor: pointer;"> here</a>
                    </div>
                    <br>
                    ...
                    <table id="dataTable" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                      ...
                      <tbody>
                        <?php
                          $number = 0;
                          $subject_query = mysqli_query($conn, "SELECT *, subject_loads.id AS sub_load_id, subject_loads.subject AS sub_id FROM subject_loads LEFT JOIN subjects ON subject_loads.subject = subjects.id WHERE subject_loads.teacher = '$user_id' ORDER BY subjects.description ASC");
                          while($rows_subject_load = mysqli_fetch_assoc($subject_query)){
                            $subject_load_id = $rows_subject_load['sub_load_id'];
                            $sub_id = $rows_subject_load['sub_id'];
                            $number+=1;
                            $total_students = 0;
                            ...
                            echo '
                              <tr>
                                ...
                                <td>
                                  <a href="students.php?id='.$subject_load_id.'" class="btn btn-success btn-sm">View Students</a>
                                </td>
                              </tr>
                            ';
